...
# def atualizar_estoque(filial, produto, tipo, quantidade):
#     # Atualiza o estoque do produto na filial
#     estoque_atual = verificar_estoque(filial, produto)
#     if tipo == 'saída':
...
# def simular_movimentos_caixa(caixa_id):
#     while True:
#         produto = random.choice(nomes)
#         filial = random.choice(filiais)
#         tipo = random.choice(tipos)
...
#             estoque_atual = verificar_estoque(filial, produto)
#             if estoque_atual < quantidade:
#                 print(f"Não há estoque suficiente de {produto} na {filial}. Saída não realizada.")
#                 continue
...
#             'tipo': tipo,
#             'quantidade': quantidade,
#             'preco': preco  # Adicionando o preço ao movimento de caixa
#         }
...
#     for i in range(num_caixas):
#         thread = threading.Thread(target=simular_movimentos_caixa, args=(i + 1,))
#         threads.append(thread)
#         thread.start()
